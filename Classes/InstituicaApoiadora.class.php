...
class InstituicaoApoiadora extends CRUD
{
    ...
    public function add()
    {
        $sql = "INSERT INTO $this->table 
                (nome_fantasia, razao_social, cnpj, telefone, endereco, bairro, cidade, cep, estado, instagram, email, descricao) 
                VALUES (:nome_fantasia, :razao_social, :cnpj, :telefone, :endereco, :bairro, :cidade, :cep, :estado, :instagram, :email, :descricao)";

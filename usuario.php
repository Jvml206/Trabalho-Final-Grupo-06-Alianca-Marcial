...
<body>
    ...
    <main class="container cadastro">
        ...
        <h1 class="tituloh1">Cadastro de Usuário</h1>
        ...
        <form action="usuario.php" method="post" class="row g3 mt-3" enctype="multipart/form-data"
            ...
            <div class="row gap-4 mb-3">
                <div class="dadosUsuario col-md-6 col-12">
                ...
                <div class="fotoCadUsuario col-md-5 col-12">
            ...
            <div class="col-12 mt-3 d-flex gap-2 justify-content-center">
                ...
                <a href="listaUsuario.php" class="btn btn-voltar">Voltar</a>
            </div>
        </form>
    </main>
